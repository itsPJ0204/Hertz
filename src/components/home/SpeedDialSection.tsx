...
function SpeedDialCard({ track }: { track: Track }) {
    ...
    return (
        <div className="relative w-[120px] h-[120px] md:w-full md:aspect-square flex-shrink-0 group cursor-pointer border-2 border-black shadow-[2px_2px_0px_0px_black] hover:shadow-[4px_4px_0px_0px_black] transition-all hover:-translate-y-1 overflow-hidden bg-gray-900 rounded-sm">
            <img src={track.image} alt={track.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 opacity-90" />
